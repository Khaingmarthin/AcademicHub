...
$announcement = null; // null for create
?>
...
<div class="mb-6 flex items-center justify-between">
    <h1 class="text-2xl font-semibold text-gray-900">Create Announcement</h1>
...
document.getElementById('announcementForm').addEventListener('submit', function(e) {
    ...
    .then(data => {
        ...
        if (data.success) {
            ...
            alertContainer.innerHTML = 'Announcement created successfully! Redirecting...';
            setTimeout(() => {
            ...
            submitBtn.innerHTML = 'Save Announcement';
        }
    })
    .catch(error => {
